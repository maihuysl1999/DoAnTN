            ...
            <Container style={{ maxWidth: "1605px", margin: "0 auto" }}>
                <div style={{ padding: "30px 0px" }}>
                                    ...
                                    <Media
                                        ...
                                        src={
                                            network.blockchain_type == "fabric"
                                                ? imagePath.fabric
                                                : network.blockchain_type == "sawtooth"
                                                ? imagePath.sawtooth
                                                : network.blockchain_type == "ethereum" &&
                                                  network.node_infrastructure.name == "bsc"
                                                ? imagePath.bsc
                                                : network.blockchain_type == "ethereum" &&
                                                  network.node_infrastructure.name == "bsct"
                                                ? imagePath.bsc
                                                : network.blockchain_type == "ethereum" &&
                                                  network.node_infrastructure.name == "ftm"
                                                ? imagePath.ftm
                                                : network.blockchain_type == "ethereum" &&
                                                  network.node_infrastructure.name == "ftmt"
                                                ? imagePath.ftm
                                                : imagePath.ethereum
                                        }
                                        alt="#"
                                ...
                                <div className="state">
                                    <div
                                        className={`dot-notify ${
                                            statusNetworkClassName[network.status] || statusNetworkClassName.ELSE
                                        }`}
                                    ></div>
                        ...
                        <CardBody style={{ padding: "30px" }}>
                                ...
                                <Col xxl={3} xs={4}>
                                    ...
                                    <strong>
                                        {network.consensus === "raft"
                                            ? "RAFT"
                                            : network.consensus === "poet"
                                            ? "PoET"
                                            : network.consensus === "pbft"
                                            ? "PBFT"
                            ...
                            {network.blockchain_type === "ethereum" ? (
                                ...
                                <>
                                    <Row style={{ marginBottom: "60px" }}>
                                        <Col xxl={3} xs={12}>
                                            <h6 style={{ color: "#8CB8D8", fontSize: "16px" }}>
                                    ...
                                    >
                                        ...
                                        <div className="d-flex" style={{ alignItems: "center" }}>
                                            <div className="state mr-4">
                                                <div
                                                    className="dot-notify dot-notification-green"
                                            ...
                                            <div className="state mr-4">
                                                <div
                                                    className="dot-notify dot-notification-yellow"
                                                    style={{ width: "12px", height: "12px" }}
                                                />
                                            ...
                                            <div className="state">
                                                <div
                                                    className="dot-notify dot-notification-red"
                                                    style={{ width: "12px", height: "12px" }}
                                                />
                    ...
                    {network.blockchain_type === "ethereum" ? null : (
                        <ManageResource
                            idNetwork={networkId}
                            typeNetwork={network.blockchain_type}
                            organizations={network.blockchain_peer_config?.organizations || []}
                        />
                    )}
                </div>
