...
export default function Notifications() {
    ...
    return (
        <Grid
            container
            spacing={2}
            style={{ display: "flex", justifyContent: "center", marginTop: "48px", marginBottom: "100px" }}
        >
                ...
                <Grid container md={6} xs={6}>
                    <Grid item md={6} xs={6} className="d-center">
                        <Checkbox
                            ...
                            onChange={(e, checked) =>
                                setNotification({ ...notification, network: { ...notification.network, UI: checked } })
                            }
                            style={{ color: "#1998F4" }}
                        ></Checkbox>
                    </Grid>
                    <Grid item md={6} xs={6} className="d-center">
                        <Checkbox
                            ...
                            onChange={(e, checked) =>
                                setNotification({
                                    ...notification,
                                    network: { ...notification.network, Email: checked },
                                })
                            }
                            style={{ color: "#1998F4" }}
                        ></Checkbox>
                ...
                <Grid container md={6} xs={6}>
                    <Grid item md={6} xs={6} className="d-center">
                        <Checkbox
                            ...
                            onChange={(e, checked) =>
                                setNotification({ ...notification, dapp: { ...notification.dapp, UI: checked } })
                            }
                            style={{ color: "#1998F4" }}
                        ></Checkbox>
                    </Grid>
                    <Grid item md={6} xs={6} className="d-center">
                        <Checkbox
                            ...
                            onChange={(e, checked) =>
                                setNotification({ ...notification, dapp: { ...notification.dapp, Email: checked } })
                            }
                            style={{ color: "#1998F4" }}
                        ></Checkbox>
                    </Grid>
                ...
                <Grid container md={6} xs={6}>
                    <Grid item md={6} xs={6} className="d-center">
                        <Checkbox
                            ...
                            onChange={(e, checked) =>
                                setNotification({ ...notification, token: { ...notification.token, UI: checked } })
                            }
                            style={{ color: "#1998F4" }}
                        ></Checkbox>
                    </Grid>
                    <Grid item md={6} xs={6} className="d-center">
                        <Checkbox
                            ...
                            onChange={(e, checked) =>
                                setNotification({ ...notification, token: { ...notification.token, Email: checked } })
                            }
                            style={{ color: "#1998F4" }}
                        ></Checkbox>
                    </Grid>
